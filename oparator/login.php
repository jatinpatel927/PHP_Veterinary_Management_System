...
<form class="main_form" action="" method="post">
    <div class="row">
        ...
        <div class=" col-md-12">
            <button class="send" id="Signup" type="submit" name="submit">Login</button>
        </div>
...
<div class="wrapper">
      ...
      <form action="" method="post">
        <div class="field">
          ...
          <input class="form-control" placeholder="Oprator" type="text" name="user">
          <label>Oprator Name</label>
        </div>
        <div class="field">
        <input class="form-control" placeholder="Password" type="text" name="pass">
...
<?php
 if($_SERVER["REQUEST_METHOD"] == "POST")
 {
   ...
   $select_user = "SELECT * FROM `oprator` WHERE o_name='$user' And o_password='$pass'";
   ...
   {
     echo "<script>alert('Oprator not Exist')</script>";
   }
 }
}
?>