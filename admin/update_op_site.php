...
if (isset($_GET['a_id'])) {
    $id  = $_GET['a_id'];
   echo $select_a_query = "SELECT * FROM op_ve_info WHERE id='$id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $old = $_POST['old_image'];
    $desc = $_POST['desc'];
    $folder = 'C:/xampp/htdocs/v-managament/oparator/img/';
if(isset($_POST['submit']))
{
    ...
    {
        echo "hi";
       $main_img = '/v-managament/oparator/img/'.$_FILES['new_image']['name'];
    }
    else
    {
        // echo "no";
        ...
        $up_query = "UPDATE `op_ve_info` SET  `name` = '$name', `image` = '$main_img', `description` = '$desc' WHERE `op_ve_info`.`id` = $id";
